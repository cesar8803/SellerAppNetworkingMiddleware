...
public class AsyncClientMW
{
    ...
    public class func getShipmentStatus(params : [String: Any], completion:@escaping (_ dataResponse: ShipmentStatusBase)-> Void, completionError: @escaping ErrorStringHandler )
    {
